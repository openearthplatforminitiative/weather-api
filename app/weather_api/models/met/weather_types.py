...
class ForecastTimeInstant(BaseModel):
    air_pressure_at_sea_level: Optional[float] = Field(
        None, example=1017.23, description="Air pressure at sea level"
    )
    air_temperature: Optional[float] = Field(
        None, example=17.1, description="Air temperature"
    )
    cloud_area_fraction: Optional[float] = Field(
        None, example=95.2, description="Amount of sky covered by clouds."
    )
    ...
    dew_point_temperature: Optional[float] = Field(
        None, example=8.1, description="Dew point temperature at sea level"
    )
    fog_area_fraction: Optional[float] = Field(
        None, example=95.2, description="Amount of area covered by fog."
    )
    relative_humidity: Optional[float] = Field(
        None, example=81.1, description="Amount of humidity in the air."
    )
    wind_from_direction: Optional[float] = Field(
        None, example=121.3, description="The directon which moves towards"
    )
    wind_speed: Optional[float] = Field(None, example=5.9, description="Speed of wind")
    wind_speed_of_gust: Optional[float] = Field(
        None, example=15.9, description="Speed of wind gust"
    )


class ForecastTimePeriod(BaseModel):
    air_temperature_max: Optional[float] = Field(
        None, example=17.1, description="Maximum air temperature in period"
    )

    air_temperature_min: Optional[float] = Field(
        None, example=11.1, description="Minimum air temperature in period"
    )
    ...
    ultraviolet_index_clear_sky_max: Optional[float] = Field(
        None, example=1.0, description="Maximum ultraviolet index if sky is clear"
    )
...
class ForecastUnits(BaseModel):
    air_pressure_at_sea_level: Optional[str] = Field(None, example="hPa")
    air_temperature: Optional[str] = Field(None, example="C")
    air_temperature_max: Optional[str] = Field(None, example="C")
    air_temperature_min: Optional[str] = Field(None, example="C")
    cloud_area_fraction: Optional[str] = Field(None, example="%")
    cloud_area_fraction_high: Optional[str] = Field(None, example="%")
    cloud_area_fraction_low: Optional[str] = Field(None, example="%")
    cloud_area_fraction_medium: Optional[str] = Field(None, example="%")
    dew_point_temperature: Optional[str] = Field(None, example="C")
    fog_area_fraction: Optional[str] = Field(None, example="%")
    precipitation_amount: Optional[str] = Field(None, example="mm")
    precipitation_amount_max: Optional[str] = Field(None, example="mm")
    precipitation_amount_min: Optional[str] = Field(None, example="mm")
    probability_of_precipitation: Optional[str] = Field(None, example="%")
    probability_of_thunder: Optional[str] = Field(None, example="%")
    relative_humidity: Optional[str] = Field(None, example="%")
    ultraviolet_index_clear_sky_max: Optional[str] = Field(None, example="1")
    wind_from_direction: Optional[str] = Field(None, example="degrees")
    wind_speed: Optional[str] = Field(None, example="m/s")
    wind_speed_of_gust: Optional[str] = Field(None, example="m/s")
...
class Meta(BaseModel):
    ...
    updated_at: str = Field(
        description="Update time for this forecast", example="2019-12-03T13:52:13Z"
    )
